...
4. **Test script**
   ...
   - **Backchannel:** While you speak, you may hear subtle empathetic backchannels (e.g. "Ok.", "I see.") at low volume — generated by Cloud TTS in the same whisper voice to acknowledge you in real time.
...
3. **Backchannel** — While speaking, listen for subtle empathetic backchannels (e.g. "Ok.", "I see.") generated by Cloud TTS in the same whisper voice at low volume.
